...
import {
  createBookService,
  deleteBookService,
  getDetailTheBookService,
  getTheBookOfAuthorService,
  getTheBookService,
  subscribeBookService,
  updateDetailTheBookService,
  unsubscribeBookService,
  listMemberSubscribeBookService,
...
export const getDetailNewBookController = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const updateDetailNewBookController = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const unsubscribeBookController = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const listMemberSubscribeBookController = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
